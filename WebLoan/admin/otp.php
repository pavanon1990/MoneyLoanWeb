                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4" style="margin-top:20px;">
                            <div class="card-header"><i class="fas fa-tablet-alt"></i> ข้อมูล OTP </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                <table id='table_otp' class="table" style="font-size:10pt;width:100%;">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Phone Number</th>
...
$(document).ready(function(){
   var table = $('#table_otp').DataTable({
      'processing': true,
      'serverSide': true,
      'serverMethod': 'post',
      'ajax': {
          'url':'functions/getotp.php'
      },
      "columnDefs": [ {
        "searchable": false,
        "orderable": false,
